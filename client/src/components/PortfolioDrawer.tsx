...
type PortfolioDrawerProps = {
  ...
  showAgeBadges: boolean;
  setShowAgeBadges: (value: boolean) => void;
  darkMode: boolean;
...
export default function PortfolioDrawer({
  ...
  setTaxFilter, showEtfs, setShowEtfs, showAgeBadges, setShowAgeBadges, darkMode,
