 ...
 */
export default function PortfolioLegend({ darkMode, onClose, visualLens, moverRingEnabled, panelRef }: { darkMode: boolean; onClose: () => void; visualLens: VisualLens; moverRingEnabled: boolean; panelRef?: RefObject<HTMLElement | null> }) {
