...
export default function PortfolioHeader({ stats, hasPortfolio, darkMode, onOpenPortfolio }: PortfolioHeaderProps) {
  ...
  return (
    <header id="ekitty-header" className={darkMode ? "fixed right-3 top-3 z-[60] w-[min(288px,calc(100vw-24px))] rounded-2xl bg-[#101617] px-3 py-2.5 text-stone-100" : "fixed right-3 top-3 z-[60] w-[min(288px,calc(100vw-24px))] rounded-2xl bg-[#faf9f5] px-3 py-2.5 text-stone-900"}>
